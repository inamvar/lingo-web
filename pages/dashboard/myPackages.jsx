        ...
        <>
            <div className='flex flex-col justify-center items-center gap-7 mt-16'>
                ...
                <div className='flex bg-white justify-evenly gap-3 items-center div-mypackage rounded p-5'>
                    ...
                    <p className='darkBlue-color font-bold text-sm md:text-lg whitespace-nowrap'>تعداد پکیج های من:</p>
                    <p className='darkBlue-color font-bold text-sm md:text-lg whitespace-nowrap'>2</p>
                </div>

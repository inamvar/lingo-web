    ...
    return(
        <>
            <div className='flex flex-col justify-center items-center gap-7'>
                <div className='flex w-11/12 md:w-2/3 bg-white justify-evenly items-center rounded p-5'>
                ...
                <div className='flex flex-col w-11/12 md:w-2/3 bg-white justify-evenly items-start gap-3 rounded p-5'>

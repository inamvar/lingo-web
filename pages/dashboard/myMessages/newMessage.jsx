            ...
            <div className='flex justify-center'>
                <div className='flex flex-col mt-16 gap-7 w-full sm:w-[75rem]'>
                    ...
                    <div className='flex justify-evenly gap-7 mx-[0.5rem]'>
                        ...
                        <Link href={AppRoutes.SendMessages} className='bg-white flex w-2/3 flex-col items-center justify-center gap-7 py-10 rounded'>
                            ...
                            <div className='flex gap-2'>
                                <p className='darkBlue-color font-bold text-xs sm:text-sm whitespace-nowrap'>پیام های ارسال شده</p>
                            </div>
                        </Link>
                        ...
                        <div className='bg-white flex w-2/3 flex-col items-center justify-center gap-7 py-10 rounded active-div-message'>
                            ...
                            <div className='flex gap-2'>
                                <p className='darkBlue-color font-bold text-xs sm:text-sm whitespace-nowrap'>ایجاد پیام جدید</p>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} name='titleMessage' className='flex flex-col gap-5 mx-[1rem]'>
                        ...
                        <p className='darkBlue-color text-xs sm:text-base'>ایجاد پیام جدید :</p>
                        ...
                        <div className='w-full flex justify-center items-center'>
                            <button type='submit' className='bg-cyan-500 p-1 text-sm btn-page text-xs sm:text-sm bg-red text-white w-[20rem]'>ثبت</button>
                        </div>

...
import {getMessageDetail, getPackageCourseList} from "../../../../services/appServices";
                ...
                <div className='flex justify-center'>
                    <div className='flex flex-col mt-16 gap-7 w-full sm:w-[75rem]'>
                        ...
                        <div className='flex flex-col gap-4 mx-[1rem]'>
                            ...
                            <div className='flex justify-between w-full'>
                                ...
                                <p className='darkBlue-color'>
                                    <DateMaker date={detail.updatedAt}/>
                                </p>
                            </div>
                        ...
                        <div className='w-full flex justify-center items-center'>
                            <Link href={appRoutes.SendMessages} className='bg-cyan-500 p-1 text-sm btn-page bg-red text-white w-[20rem] text-center hover:bg-red-600'>بازگشت</Link>
                        </div>
...
export async function getServerSideProps(ctx)
{
    ...
    const result = await getMessageDetail(id,ctx);

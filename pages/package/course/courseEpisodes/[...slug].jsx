...
import Black from "../../../../public/picture/black.jpg";
    ...
    return(
        <div className='flex justify-center items-center mt-16'>
            <div className='flex flex-col md:flex-row gap-5 px-0 md:p-3 justify-center items-center md:items-start w-full lg:w-10/12'>
                ...
                <div className='w-full md:w-2/3 flex order-first md:order-last flex-col gap-5 rounded-none'>

                    <div className='relative'>
                        <Image src={Black} className='z-0 absolute' alt=''/>
                        <div id='videoPlayerTag' className='video-div rounded-none bg-black'></div>
                    </div>
                    ...
                    <div className='w-full flex justify-center items-center mt-3'>
                        <Link href={AppRoutes.CourseReturn(result.slug)} className='bg-red btn-page hover:bg-red-600 text-white text-center w-fit hidden md:block'>بازکشت به صفحه ی خرید دوره</Link>
                    </div>

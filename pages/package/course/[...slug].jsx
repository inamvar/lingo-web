                    ...
                    <div className='flex flex-col w-11/12 md:w-1/2 gap-6'>
                        ...
                        <div className='flex flex-col gap-6'>
                            <div className='flex relative mt-5'>
                                ...
                                {(courseDetail.chapters.length>=1 && courseDetail.userHasPurchasedCourse==false && courseDetail.discount!=null && courseDetail.discount.discountValue!=0) &&<div className='absolute discount-icon'>

    ...
    return(
        <>
            <div className='flex flex-col items-center gap-8 mt-7'>
                <div className='flex flex-col md:flex-row gap-8 md:w-11/12 lg:w-4/5 w-full items-center md:items-start'>
                    <div className='flex flex-col w-11/12 md:w-1/2 gap-7'>
                        <div className='flex flex-col bg-white items-center p-6 gap-5 rounded-xl darkBlue-color justify-center'>
                            <p className='whitespace-nowrap font-bold text-xl whitespace-pre-wrap'>{courseDetail.title}</p>
                            <div className='border border-black rounded'>
                                <Image src={courseDetail.thumbnailImageUrl} className='w-56 border border-black rounded' width={450} height={450} alt='picture'/>
                            </div>
                        </div>
                        <div className='flex justify-center md:justify-evenly gap-6'>
                            ...
                            <div className='bg-white whitespace-nowrap p-3 sm:p-6 font-bold rounded w-3/4 text-center darkBlue-color sm:text-md text-sm'>0 دقیقه</div>
                        </div>
                    </div>
                    <div className='flex flex-col w-11/12 md:w-1/2 gap-6'>
                        <p className='darkBlue-color font-bold text-xl'>ویدئوهای دوره</p>
                ...
                <div className='flex flex-col gap-8 md:w-11/12 lg:w-4/5 w-full items-center md:items-start'>
                    <p className='darkBlue-color font-bold text-xl'>توضیحات دوره</p>
                    <p>{courseDetail.description}</p>
                </div>
                <div className='flex flex-col justify-center items-center lg:w-4/5 gap-9 mt-9 w-full'>
                    <div>

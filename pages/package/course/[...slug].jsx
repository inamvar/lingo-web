                ...
                <div className='flex flex-col md:flex-row gap-8 md:w-11/12 w-full items-center md:items-start'>
                    ...
                    <div className='flex flex-col w-11/12 md:w-1/2 gap-6'>
                        ...
                        <div className='flex relative mt-5'>
                            {/*<Link href={AppRoutes.DetailCourse} className='bg-red btn-page text-white text-center w-full'>دوره را می خرم</Link>*/}
                            <Link href={AppRoutes.Cart} className='bg-red btn-page text-white text-center w-full'>دوره را می خرم</Link>
                            <svg className='absolute discount-icon' width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">

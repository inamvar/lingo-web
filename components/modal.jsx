                    ...
                    <ModalBody>
                        ...
                        <div className='bg-white rounded-lg'>
                            <div className='flex d-rtl justify-between rounded-lg border-2 border-blue-950'>
                                <input ref={searchInputRef} type='text' className='rounded py-4 px-3 text-black text-xs md:text-sm focus:outline-none w-3/4' placeholder='به دنبال یادگیری چه مهارتی هستید ؟'/>
                                {/*<a className='p-4 w-1/4 text-center bg-darkBlue rounded-tl-md rounded-bl-md text-sm text-white hidden md:block'>جست و جو</a>*/}
                                <a onKeyPress={handleKeyPress} onClick={handleClick} className='m-2'>

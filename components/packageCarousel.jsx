...
const PackageCarousel = (props) => {
    ...
    if (packageItems.length>0){
        const {
            ...
            withLoop: false,
            gutter:10,
            itemsPerSlide:packageItems.length,
        ...
        return (
            ...
            <div className='flex flex-row div-cersoul justify-center'>
                <button className='next-button-cersoul bg-white p-3' onClick={slideToNextItem}>
                ...
                <button className='Previous-button-cersoul bg-white p-3' onClick={slideToPrevItem}>
                    <svg width="23" height="34" viewBox="0 0 23 34" fill="none" xmlns="http://www.w3.org/2000/svg">
